...
def motion1(event):
    ...
    global CHOSE, AREA, MATRIX_AREA, TAKEE, COORDS, TAKING, FR, HAS_MOVES, DONE
    HAS_MOVES = False
    MATRIX_AREA = moves_bot(AREA, "white")[0]
    for i in MATRIX_AREA:
        for j in i:
            if j != []:
                HAS_MOVES = True
                break
